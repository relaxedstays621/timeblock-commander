...
7. Read `structure/System Guide/architecture.md` for the project-level boundary. If `structure/Purpose/scope.md` is filled in, read it as the narrower session-or-task scope contract on top of that boundary.
